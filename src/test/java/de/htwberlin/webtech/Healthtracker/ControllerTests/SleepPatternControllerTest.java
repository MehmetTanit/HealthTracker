...
public class SleepPatternControllerTest {
    ...
    public void testGetSleepPatterns() throws Exception {
        ...
        // Expected result
        String expected = "[{\"id\":1,\"dateRecorded\":\"2023-01-01T10:00:00\",\"sleepDuration\":8,\"lightSleepDuration\":3,\"deepSleepDuration\":5,\"interruptions\":2,\"sleepQuality\":83.33333333333334}," +
                "{\"id\":2,\"dateRecorded\":\"2023-01-02T10:00:00\",\"sleepDuration\":7,\"lightSleepDuration\":2,\"deepSleepDuration\":5,\"interruptions\":3,\"sleepQuality\":85.0}]";
